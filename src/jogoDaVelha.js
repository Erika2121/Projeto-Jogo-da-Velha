...
let vBoard = [] //opcional, p/ espelhar no console e dar suporte na regiao
let turnPlayer = "" //jogador da vez

function updateTitle() {
  const playerInput = document.getElementById(turnPlayer)
  document.getElementById("turnPlayer").innerText = playerInput.value //esse turnPlayer é o id do span de h2
}
...
function initializeGame() {
  ...
  updateTitle() //atualizar o title com o valor atual, no caso o player1
  // Limpa o tabuleiro p/ cada regiao (caso seja necessário) e adiciona os eventos de clique
